...
class StreamDelete extends Component { 
    ...
    render() {
        return ( <Modal title="Delete Stream" content="Are u sure u want to delete this
                        stream?" actions={this.renderActions()} onDismiss={() => history.push('/')} />
        );
    }
}
